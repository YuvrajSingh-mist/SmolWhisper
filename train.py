...
def prepare_dataset(split, device, batch_size):
    ...
    def collate_fn(batch):
        ...
        input_encodings = tokenizer(texts, padding='max_length', max_length=ModelArgs.block_size, truncation=True, return_overflowing_tokens=True, return_tensors="pt")
...
class AttentionHead(nn.Module):
    ...
    def forward(self, x):
        ...
        # if(use_flash_attention == False):
            ...
            out = out.transpose(1, 2).contiguous().view(ModelArgs.batch_size, ModelArgs.block_size, -1)
            return out
